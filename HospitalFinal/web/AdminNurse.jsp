...
<body>
    ...
    <div class="uperPanel">
        ...
        <div class="upSep">
            <form action="">
                <p class="lbldp">Nurse ID:</p>
                <select name="nid" id="" class="patDp">
                    <%
                        DBConnect db1 = new DBConnect();
                        String query = "select * from staff where STS='Nurse';";
                        ResultSet res1 = db1.readData(query);
                        try{
                            while(res1.next()){
                                %>
                ...
                <button class="loadBtn" value="Load" name="LoadNID">Load</button>
                <% 
                    String getNLoad = request.getParameter("LoadNID");
                %>
            </form>
        </div>
            <%
                ...
                String queryOnn = "select * from staff where STS = 'Nurse';";
        ...
        <div class="upSep" style="width: 69%">
            <div class="detCon lCon">
                <div class="detConInSep dciL">
                    <p class="conLbl">No Of <br>Nurses</p>
                </div>
            ...
            <div class="detCon mCon">
                <div class="detConInSep dciL">
                    <p class="conLbl">No Of <br> Online Nurses</p>
                </div>
                <div class="detConInSep dciR">
            ...
            <div class="detCon rCon">
                <div class="detConInSep dciL">
                    <p class="conLbl">No Of <br> Offline Nurses</p>
                </div>
                <div class="detConInSep dciR">
    ...
    <div class="m2">
        ...
        <div class="m2Sep">
            <br>
            <form action="Servelet_UpdateNurse">
                 ...
                 <%
                    ...
                    <input type="text" class="inpM2" name="fn" id="fn" value=<%= resDoc.getString("FN")%>>
