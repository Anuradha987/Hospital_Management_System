...
public class Servelet_AddDailyReport extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            // getting values from AddDailyReport.jsp ..
            ...
            String query = "insert into dailyreport values ('"+id+"','"+pid+"','"+nurseID+"','"+dr+"','"+date+"','"+time+"');";
